...
# r=requests.get("res_api", headers={"content-type":"text"})

# requests.get(
#     'https:77ue66yk77.execute-api.us-east-2.amazonaws.com/dev/streams/faucovidstreamsentiment')

# requests.get(
#     'https://77ue66yk77.execute-api.us-east-2.amazonaws.com/dev/streams/faucovidstreamsentiment/sharditerator?shard-id=shardId-000000000000')
